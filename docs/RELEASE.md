...
Current track: **`1.2.0` stable** (alpha series ended at `0.1.0-alpha.5`).
...
```bash
npm view @agentskit/doc-bridge@1.2.0 version dist.integrity
npx ak-docs@1.2.0 --version
...
```bash
npm i -D @agentskit/doc-bridge@1.2.0
npx ak-docs init
npx ak-docs index
